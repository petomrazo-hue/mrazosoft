...
(function () {
  ...
  var i18n = {
    sk: {
      ...
      "services.from": "už od", "services.guarantee": "Pevná cena dohodnutá vopred — žiadne prekvapenia. Nezáväznú ponuku pošlem do 24 hodín.",
      ...
      "proj.view": "Otvoriť naživo", "proj.private": "Ukážka na vyžiadanie", "status.live": "Live", "status.dev": "Vo vývoji",
    ...
    en: {
      ...
      "services.from": "from", "services.guarantee": "Fixed price agreed up front — no surprises. I'll send a no-commitment quote within 24 hours.",
      ...
      "proj.view": "Open live", "proj.private": "Demo on request", "status.live": "Live", "status.dev": "In development",
