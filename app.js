...
(function () {
  ...
  var i18n = {
    sk: {
      ...
      "cta.title": "Máte projekt alebo nápad? Napíšme si.", "cta.text": "Povedzte mi pár viet o tom, čo potrebujete. Do 24 hodín máte odpoveď a návrh ďalšieho kroku — nezáväzne a po slovensky.", "cta.wa": "Napíšte na WhatsApp", "cta.trust": "Odpoveď do 24 h · Bez záväzku · Kód patrí vám",
      ...
      "hero.trust": "Odpoveď do 24 h · nezáväzne · kód patrí vám",
      ...
      "proj.pirohovo.p": "Nová reštaurácia s domácimi pirohmi potrebovala web, ktorý hosťa rýchlo dovedie k objednávke cez donáškové služby a ukáže, kde stánok nájde.", "proj.pirohovo.s": "Postavil som tmavý, filmový web s plným menu, otváracími hodinami naživo a objednávaním cez Wolt, Bolt aj WhatsApp.", "proj.pirohovo.r": "Hosť vidí ponuku, otváracie hodiny aj rozvoz na jednom mieste a objedná na pár klikov — web je naživo na pirohovo.eu.",
    ...
    en: {
      ...
      "cta.title": "Got a project or an idea? Let's talk.", "cta.text": "Tell me a few lines about what you need. Within 24 hours you'll have a reply and a suggested next step — no commitment, plain language.", "cta.wa": "Message on WhatsApp", "cta.trust": "Reply within 24 h · No commitment · The code is yours",
      ...
      "hero.trust": "Reply within 24 h · no commitment · the code is yours",
      ...
      "proj.pirohovo.p": "A new restaurant serving homemade pierogi needed a website that quickly leads guests to order via delivery apps and shows where to find the stand.", "proj.pirohovo.s": "I built a dark, cinematic website with a full menu, live opening hours and ordering through Wolt, Bolt and WhatsApp.", "proj.pirohovo.r": "Guests see the menu, opening hours and delivery in one place and order in a few clicks — the site is live at pirohovo.eu.",
