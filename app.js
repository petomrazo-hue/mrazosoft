...
(function () {
  ...
  var i18n = {
    sk: {
      ...
      "hero.sub": "Som Peter Mráz — vývojár z Popradu. Dostanem vašu firmu online: navrhnem a postavím web, e-shop alebo appku, ktorá pôsobí dôveryhodne, načíta sa okamžite a privádza dopyty. Všetko v jedných rukách.",
      ...
      "pkg.eyebrow": "Riešenia na mieru", "pkg.title": "S čím vám pomôžem", "pkg.sub": "Od e-shopu po jednostránkový web. Rozsah aj postup si potvrdíme vopred — ešte pred prvým riadkom kódu.", "pkg.cta": "Mám záujem",
      ...
      "pkg.app.t": "Webová aplikácia / PWA", "pkg.app.for": "Pre nástroje, portály a nápady, ktoré majú fungovať všade.", "pkg.app.l1": "Appka pre mobil aj počítač", "pkg.app.l2": "Offline režim", "pkg.app.l3": "Inštalácia bez obchodu", "pkg.app.l4": "Prihlásenie používateľov", "pkg.app.l5": "Riešenie na mieru", "services.guarantee": "Máte projekt alebo nápad? Rád sa o ňom pozhováram — stačí sa ozvať.",
    ...
    en: {
      ...
      "hero.sub": "I'm Peter Mráz — a developer from Poprad. I'll get your business online: I design and build a website, e-shop or app that looks credible, loads instantly and brings inquiries. All in one pair of hands.",
      ...
      "pkg.eyebrow": "Tailored solutions", "pkg.title": "What I can help with", "pkg.sub": "From a full e-shop to a simple one-pager. We agree on the scope up front — before the first line of code.", "pkg.cta": "I'm interested",
      ...
      "pkg.app.t": "Web app / PWA", "pkg.app.for": "For tools, portals and ideas that should work everywhere.", "pkg.app.l1": "App for mobile & desktop", "pkg.app.l2": "Offline mode", "pkg.app.l3": "Install without a store", "pkg.app.l4": "User login", "pkg.app.l5": "Tailor-made", "services.guarantee": "Got a project or an idea? Happy to talk it through — just get in touch.",
