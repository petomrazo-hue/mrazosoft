...
(function () {
  ...
  var i18n = {
    sk: {
      ...
      "hero.stat1": "nasadených projektov", "hero.stat2": "kód patrí klientovi", "hero.stat3": "odpoveď na dopyt", "hero.stat3v": "pár hodín",
      ...
      "testi.eyebrow": "Výsledky", "testi.title": "Výsledky namiesto rečí", "testi.sub": "Reálne projekty z praxe, ich výsledky — a recenzie klientov na Google.",
      ...
      "greview.count": "4 recenzie na Google", "greview.q": "„Už od prvého kontaktu milý a ústretový prístup, práca je spravená presne podľa mojich predstáv. Odporúčam firmu MRAZOSOFT!\"", "greview.by": "— Diana, recenzia na Google", "greview.link": "Všetky recenzie ↗",
    ...
    en: {
      ...
      "hero.stat1": "shipped projects", "hero.stat2": "code belongs to the client", "hero.stat3": "reply to an enquiry", "hero.stat3v": "a few hours",
      ...
      "testi.eyebrow": "Results", "testi.title": "Results, not big talk", "testi.sub": "Real projects from practice, their results — and client reviews on Google.",
      ...
      "greview.count": "4 reviews on Google", "greview.q": "“Kind and helpful from the very first contact — the work was done exactly as I imagined. I recommend MRAZOSOFT!” (translated from Slovak)", "greview.by": "— Diana, Google review", "greview.link": "All reviews ↗",
