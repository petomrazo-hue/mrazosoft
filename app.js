...
(function () {
  ...
  var i18n = {
    sk: {
      ...
      "services.ecom.t": "Tvorba a úpravy e-shopov (PrestaShop)", "services.ecom.d": "Tvorba e-shopov a úpravy PrestaShop — moduly a integrácie, produktové feedy, Heureka, exporty, importy, ERP napojenia a automatizácia rutiny.", "services.ecom.price": "od 1 200 € · úpravy od 45 €/hod",
      ...
      "pkg.eyebrow": "Riešenia na mieru", "pkg.title": "S čím vám pomôžem", "pkg.sub": "Od e-shopu po jednostránkový web za 199 €. Cenu dostanete pevnú a vopred — ešte pred prvým riadkom kódu.", "pkg.price": "Cena podľa rozsahu", "pkg.cta": "Mám záujem",
      "pkg.start.t": "Jednostránkový web", "pkg.start.for": "Pre živnostníkov, ktorí potrebujú byť online tento týždeň.", "pkg.start.l1": "Jedna stránka", "pkg.start.l2": "Texty aj fotky", "pkg.start.l3": "Formulár alebo WhatsApp", "pkg.start.l4": "Doména a spustenie", "pkg.start.l5": "Online do 72 hodín", "pkg.start.price": "od 199 €",
    ...
    en: {
      ...
      "services.ecom.t": "E-shop development (PrestaShop)", "services.ecom.d": "E-shop development and PrestaShop work — modules and integrations, product feeds, Heureka, exports, imports, ERP connections and routine automation.", "services.ecom.price": "from €1,200 · tweaks from €45/hr",
      ...
      "pkg.eyebrow": "Tailored solutions", "pkg.title": "What I can help with", "pkg.sub": "From a full e-shop to a €199 one-pager. You get a fixed price up front — before the first line of code.", "pkg.price": "Price by scope", "pkg.cta": "I'm interested",
      "pkg.start.t": "One-page website", "pkg.start.for": "For sole traders who need to be online this week.", "pkg.start.l1": "One page", "pkg.start.l2": "Copy and photos", "pkg.start.l3": "Form or WhatsApp", "pkg.start.l4": "Domain and launch", "pkg.start.l5": "Online within 72 hours", "pkg.start.price": "from €199",
