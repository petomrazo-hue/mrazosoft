# Pôvod a licencie fotografií

Všetky fotografie pochádzajú z fotobanky **Pexels** a sú použité podľa **Pexels License**
(https://www.pexels.com/license/): bezplatné použitie na komerčné aj nekomerčné účely,
úprava povolená, atribúcia nie je povinná (uvádzame ju dobrovoľne).

Stiahnuté: 2.7.2026. Konverzia: JPEG → WebP (cwebp q80), tmavé tónovanie robí CSS overlay na webe.

> Poznámka pre klienta: stock fotografie sú dočasný placeholder pre návrh —
> pred spustením webu sa vymenia za reálne fotografie salónu.

| Súbor | Autor | Zdroj (Pexels stránka fotky) |
|---|---|---|
| hero.webp | Felix Young | https://www.pexels.com/photo/portrait-of-woman-26780885/ |
