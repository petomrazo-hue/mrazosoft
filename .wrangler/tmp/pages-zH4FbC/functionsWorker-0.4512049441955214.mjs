...
var b64utf8 = /* @__PURE__ */ __name((str) => btoa(String.fromCharCode(...new TextEncoder().encode(str))), "b64utf8");
var encSubject = /* @__PURE__ */ __name((str) => "=?utf-8?B?" + b64utf8(str) + "?=", "encSubject");
...
var reject = /* @__PURE__ */ __name(() => json({ success: false, error: "validation" }, 400), "reject");
var clean = /* @__PURE__ */ __name((v, max) => String(v ?? "").replace(/[\u0000-\u0008\u000b\u000c\u000e-\u001f\u007f]/g, "").trim().slice(0, max), "clean");
...
// ../.wrangler/tmp/pages-zH4FbC/functionsRoutes-0.03424857419007599.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-ki4qEP/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-ki4qEP/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.4512049441955214.mjs.map
